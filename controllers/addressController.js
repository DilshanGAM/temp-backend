...
export const createAddress = async (req, res) => {
    const { addressLine1, addressLine2, city, state, postalCode, country, name } = req.body;
    const email = req.user.email;

    try {
        const newAddress = new Address({ email, addressLine1, addressLine2, city, state, postalCode, country, name });
